    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="space-y-4">
        <p>
          ...
          >
            This Privacy Policy describes how Naturaeon (the &quot;
          </span>
          <strong
            style={{
              fontFamily:
          ...
          >
            &quot;) collects, uses, and discloses your personal information when
            you visit, use our services, or make a purchase from
            nordicbiolabs.com (the &quot;
          </span>
          <strong
            style={{
              fontFamily:
          ...
          >
            &quot; means you as the user of the Services, whether you are a
            customer, website visitor, or another individual whose information
        ...
        <ul>
          <li>
            <strong>Basic contact details</strong> including your name, address,
            phone number, email.
          </li>
          <li>
          ...
          <li>
            <strong>Shopping information</strong> including the items you view,
            put in your cart or add to your wishlist.
          </li>
          <li>
        ...
        <p>
          ...
          interaction with the Services (&quot;<strong>Usage Data</strong>
          &quot;). To do this, we may use cookies, pixels and similar
          technologies (&quot;
          <strong>Cookies</strong>&quot;). Usage Data may include information
          about how you access and use our Site and your account, including
          device information, browser information, information about your
          network connection, your IP address and other information regarding
        ...
        <p>
          ...
          practices. For more information, see the section below,{" "}
        ...
        <ul>
          ...
          <li>
            ...
            services and advertise to you.
          </li>
          <li>
            Our business and marketing partners will use your information in
        ...
        <p>
          ...
          <em>&quot;How we Collect and Use your Personal Information&quot;</em>{" "}
          and <em>&quot;How we Disclose Personal Information&quot;</em>:
        </p>
        <table className="bg-white border border-gray-200 p-4">
          <tbody className="border border-gray-200">
            <tr className="border m-1 border-gray-200">
              <th>Category</th>
              <th>Categories of Recipients</th>
            </tr>
            <tr className="border m-1 border-gray-200">
              <td className="border m-1 border-gray-200">
        ...
        <ul>
          ...
          <li>
            ...
            to ask us to stop or restrict our processing of personal
            information.
          </li>
          <li>
          ...
          <li>
            <strong>Appeal:</strong> You may have a right to appeal our decision
            if we decline to process your request. You can do so by replying
        ...
        <p>
          ...
          <i>
            ...
            home address. We (or service providers on our behalf) may then send
            communications and marketing to these email or home addresses. You
        ...
        <p>
          ...
          available to you, please email us at contact@naturaeon.com
        </p>
      </div>
    </div>
  );
