...
export default function Autocomplete({
  ...
  return (
    <div className="relative flex rounded-md w-full" ref={dropdownRef}>
      {/* Button mở dropdown */}
      ...
      <Button
        ...
        variant="outline"
        className="w-full h-12 justify-between border border-gray-200  focus:border-gray-600"
      >
        {selected ? (
          <span className="text-sm font-normal flex items-center space-x-1.5">
            <img
      ...
      {/* Menu dropdown */}
      <div
        className={`absolute w-full max-w-80 bg-white border border-gray-300 rounded-md shadow-lg mt-12 z-10 transition-all duration-200 ease-in-out ${
          isOpen
