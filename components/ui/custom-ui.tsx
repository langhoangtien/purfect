...
function Input({
  ...
  return (
    <div className="relative w-full">
      ...
      <label
        htmlFor={props.id}
        className="absolute text-[16px] text-gray-500  duration-300 transform -translate-y-3 scale-[0.8] top-3 z-10 origin-[0] start-4  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.8] peer-focus:-translate-y-3 "
      >
        {props.placeholder}
      </label>
    </div>
